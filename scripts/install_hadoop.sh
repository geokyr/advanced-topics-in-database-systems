...
download__hadoop () {
	...
	echo 'export HADOOP_INSTALL=/home/user/hadoop-3.3.4' >> ~/.bashrc
...
## Set the two datanodes for the distributed filesystem
		echo "master" > /home/user/hadoop-3.3.4/etc/hadoop/workers
		echo "slave" >> /home/user/hadoop-3.3.4/etc/hadoop/workers

## Export JAVA_HOME variable for hadoop
		sed -i '/export JAVA\_HOME/c\export JAVA\_HOME=\/usr\/lib\/jvm\/java-8-openjdk-amd64' /home/user/hadoop-3.3.4/etc/hadoop/hadoop-env.sh
}
